...
export default function MessageInput({ onSendMessage, disabled = false, enabledCount = 0 }: MessageInputProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-white to-gray-50 border-t border-gray-200/50 p-6 shadow-lg">
      <div className="max-w-full mx-auto">
        <div className="relative">
          <textarea
            ...
            disabled={disabled}
            className="w-full px-6 py-4 pr-16 border border-gray-200 rounded-2xl resize-none focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
            rows={1}
            style={{
              minHeight: '56px',
              maxHeight: '200px',
