      ...
      <div className="relative w-full max-w-md mx-4">
        <div className="rounded-2xl border border-white/10 bg-white/[0.06] p-6 shadow-2xl backdrop-blur-md">
          ...
          <p className="mt-1 text-xs text-gray-300/90">
            Pick up your conversations across models—seamlessly.
          </p>
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            ...
            <button disabled={isLoading} className="w-full py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 disabled:opacity-60 shadow-lg shadow-blue-900/20">{isLoading? 'Signing in…':'Sign In'}</button>
          </form>
